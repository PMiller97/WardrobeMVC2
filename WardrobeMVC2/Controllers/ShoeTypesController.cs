...
namespace WardrobeMVC2.Controllers
{
    public class ShoeTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeTypeID,TypeName")] ShoeType shoeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeTypeID,TypeName")] ShoeType shoeType)
        {
            if (ModelState.IsValid)
            {
