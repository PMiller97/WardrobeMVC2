...
namespace WardrobeMVC2.Controllers
{
    public class BottomTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomTypeID,TypeName")] BottomType bottomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomTypeID,TypeName")] BottomType bottomType)
        {
            if (ModelState.IsValid)
            {
